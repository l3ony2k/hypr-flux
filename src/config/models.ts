...
export const modelValidations = {
  ...
  'recraft-v3': z.object({
    ...
    style: z.enum([
      'digital_illustration', 'digital_illustration/pixel_art',
      ...
      'realistic_image/hdr', 'realistic_image/natural_light',
      'realistic_image/studio_portrait', 'realistic_image/enterprise',
      'realistic_image/motion_blur', 'vector_illustration',
